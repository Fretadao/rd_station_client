...
RSpec.describe RDStationClient::Event::Conversion::Create do
  describe '#run' do
    let(:event_body) do
      {
        ...
        event_family: 'CDP',
        payload: {
          conversion_identifier: 'my_identifier',
    ...
    before do
      ...
      stub_post(
        ...
        to: 'https://api.rd.services/platform/conversions',
    ...
    context 'and event has invalid params' do
      ...
      it 'fails with unprocessable entity', :aggregate_failures do
        result = described_class.(conversion_identifier: 'my_identifier', email: 'person@mail.com')
