...
RSpec.describe RDStationClient::Contact::Update do
  describe '#run' do
    ...
    describe 'updating by path_params' do
      context 'when path params is email' do
        ...
        context 'and contact is found' do
          ...
          it 'updates contact info', :aggregate_failures do
            result = described_class.(
              path_params: { identifier_type: :email, identifier_value: 'contact@email.com' },
              body: { job_title: 'President' }
            )
      ...
      context 'when path params is uuid' do
        context 'and contact is not found' do
          ...
          it 'fails with not found', :aggregate_failures do
            result = described_class.(
              path_params: { identifier_type: :uuid, identifier_value: 'uuid-123' },
              body: { job_title: 'President' }
            )
    ...
    describe 'updating by direct attribute' do
      context 'when attribute is email' do
        context 'and contact is not found' do
          ...
          it 'fails with not found', :aggregate_failures do
            result = described_class.(email: 'contact@email.com', body: { job_title: 'President' })
      ...
      context 'when attribute is uuid' do
        context 'and contact is not found' do
          ...
          it 'fails with not found', :aggregate_failures do
            result = described_class.(uuid: 'uuid-123', body: { job_title: 'President' })
